...
const char PAGE_usermod[] PROGMEM = R"=====(<!DOCTYPE html><html><body>未设置 usermod 自定义页面</body></html>)=====";
...
</style></head><body><h2>WLED 软件更新</h2><form method="POST" action="/update" 
id="uf" enctype="multipart/form-data" onsubmit="U()">已安装版本: 0.13.0-b2-ch<br>
下载最新的二进制文件(en): <a href="https://github.com/Aircoookie/WLED/releases" 
target="_blank"><img 
src="https://img.shields.io/github/release/Aircoookie/WLED.svg?style=flat-square">
</a><br><input type="file" class="bt" name="update" required><br><input 
type="submit" class="bt" value="Update!"><br><button type="button" class="bt" 
onclick="B()">返回</button></form><div id="msg"><b>更新中...</b><br>请不要关闭或刷新页面 :)
</div></body></html>)=====";
...
<div class="main"><h1>欢迎来到 WELD!</h1><h3>汉化说明:汉化版本:0.01 部分由谷歌生草机翻译 翻译by PeterTea
</h3><h3>感谢您安装我的应用程序!</h3><b>后续步骤:</b><br><br>在此处将模块连接到您的本地 WiFi!<br><button 
onclick='window.location.href="/settings/wifi"'>无线设置</button><br><i>
仅在 AP 模式下(试试这个)?</i><br><button onclick='window.location.href="/sliders"'>控制页面
</button><br></div></body></html>)=====";
...
<h1>404 Not Found</h1><b>Akemi 不知道你要去哪里...</b><br><br><button 
onclick='window.location.href="/sliders"'>返回</button></body></html>)=====";
